...
{
    if($donnees['nom_categorie']=='PARFUMS')
    {
         ?>
            ...
            <ul class="product-filter-menu">
                 ...
                 $bdd = new PDO('mysql:host=localhost;dbname=id12825075_pcosm;charset=utf8', 'id12825075_admin', 'pcosm123456');
$i=31;
    $reponse = $bdd->query("SELECT * FROM sous_categorie WHERE id_categorie=6");
while($donnees= $reponse->fetch())   		
{
    if($donnees['nom_scategorie']=='Eau de toilette')
    {
         ?>
    ...
    else if($donnees['nom_scategorie']=='Parfums enfant')
    {
        
        ?>
                <li  style="	margin: 0;"><a href="portfolio31.php"  style="font-size: 11px; color:purple"><?php echo $donnees['nom_scategorie'] ?></a></li>
                <?php
            $i++;
    }
        else if($donnees['nom_scategorie']=='Parfums homme')
    {
        
        ?>
                <li  style="	margin: 0;"><a href="portfolio32.php"  style="font-size: 11px; "><?php echo $donnees['nom_scategorie'] ?></a></li>
                <?php
            $i++;
    }
     else if($donnees['nom_scategorie']=='Parfums femme')
    {
        
        ?>
                <li  style="	margin: 0;"><a href="portfolio33.php"  style="font-size: 11px; "><?php echo $donnees['nom_scategorie'] ?></a></li>
                <?php
            $i++;
    }
}
			...
			<div class="row">
			 ...
			 <?php
                 $bdd = new PDO('mysql:host=localhost;dbname=id12825075_pcosm;charset=utf8', 'id12825075_admin', 'pcosm123456');
$i=0;
    $reponse = $bdd->query("SELECT * FROM produit WHERE id_scategorie=17");
while($donnees= $reponse->fetch())   
{
        $reponse2 = $bdd->query("SELECT * FROM sous_categorie WHERE id_scategorie=17");
        ...
        while($donnees3= $reponse3->fetch())   
{
   ...
   ?>
            ...
            $_SESSION['pf'] = "31"; ?>"><i class="fa fa-shopping-bag"></i><span>Add to Cart</span></a>
							</div>
						</div>
						<div class="pi-text">
