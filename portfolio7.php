...
{
    if($donnees['nom_categorie']=='RASAGE')
    {
         ?>
            ...
            <ul class="product-filter-menu">
                 ...
                 $bdd = new PDO('mysql:host=localhost;dbname=id12825075_pcosm;charset=utf8', 'id12825075_admin', 'pcosm123456');
$i=36;
    $reponse = $bdd->query("SELECT * FROM sous_categorie WHERE id_categorie=8");
while($donnees= $reponse->fetch())  	 			
{
    if($donnees['nom_scategorie']=='Materiel de rasage')
    {
         ?>
                				
                <li style="	margin: 0;"><a href="portfolio<?php echo $donnees['id_categorie']-1 ?>.php" style=" font-size: 11px; color:purple"><?php echo $donnees['nom_scategorie'] ?></a></li>
                <?php
    }
    else if($donnees['nom_scategorie']=='Produits de rasage')
    {
        ...
        ?>
			...
			<div class="row">
			 ...
			 <?php
                 $bdd = new PDO('mysql:host=localhost;dbname=id12825075_pcosm;charset=utf8', 'id12825075_admin', 'pcosm123456');
$i=0;
    $reponse = $bdd->query("SELECT * FROM produit WHERE id_scategorie=23");
while($donnees= $reponse->fetch())   
{
        $reponse2 = $bdd->query("SELECT * FROM sous_categorie WHERE id_scategorie=23");
        ...
        while($donnees3= $reponse3->fetch())   
{
   ...
   ?>
            ...
            $_SESSION['pf'] = "7"; ?>"><i class="fa fa-shopping-bag"></i><span>Add to Cart</span></a>
							</div>
						</div>
						<div class="pi-text">
