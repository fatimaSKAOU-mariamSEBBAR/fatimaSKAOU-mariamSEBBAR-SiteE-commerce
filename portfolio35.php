...
while($donnees= $reponse->fetch())  			 			
{
    ...
    else if($donnees['nom_scategorie']=='Soin et Coloration')
    {
        ...
        ?>
			...
			<div class="row">
                 ...
                 $bdd = new PDO('mysql:host=localhost;dbname=id12825075_pcosm;charset=utf8', 'id12825075_admin', 'pcosm123456');
$i=0;
    $reponse = $bdd->query("SELECT * FROM produit WHERE id_scategorie=22");
while($donnees= $reponse->fetch())   
{
        $reponse2 = $bdd->query("SELECT * FROM sous_categorie WHERE id_scategorie=22");
        ...
        while($donnees3= $reponse3->fetch())   
{
   ...
   ?>
            ...
            $_SESSION['pf'] = "35"; ?>"><i class="fa fa-shopping-bag"></i><span>Add to Cart</span></a>
							</div>
						</div>
						<div class="pi-text">
